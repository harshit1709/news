	...
	private static NewsService ourInstance = new NewsService();
	 ...
	 public static NewsService getInstance() {
	    ...
	    public static List<Example> sendRefinedUpdate(String country,String category,String source123) throws IOException {	
	    	...
	    	String urlString = "https://newsapi.org/v2/top-headlines?apiKey=472a7a9d21c742ac8fe1cc754c1c8855&country="+country+"&category="+category+"&source="+source123+"";
	    ...
	    public static List<Example> sendCategorizedUpdate(String country,String category) throws IOException {
	    	...
	    	String urlString = "https://newsapi.org/v2/top-headlines?apiKey=472a7a9d21c742ac8fe1cc754c1c8855&country="+country+"&category="+category+"";
	    ...
	    public static List<Example> sendSourcedUpdate(String country,String source123) throws IOException {
	    	...
	    	String urlString = "https://newsapi.org/v2/top-headlines?apiKey=472a7a9d21c742ac8fe1cc754c1c8855&country="+country+"&source="+source123+"";
